         ...
         <div class="container">
            <div class="row">
               ...
               <div class="col-lg-3 col-md-6 col-sm-6">
                  ...
                  <form action="footeremail.jsp" id="request" class="main_form"  >
                     <div class="row">
                        <div class="col-md-12 ">
                           <input type="text" name="email1" class="news" placeholder="Your Email" >
                        </div>
                        <div class="col-md-12">
                         <input type="submit" value="submit"   class="send_btn" ></button>  
                        </div>
                     </div>
                  </form>
